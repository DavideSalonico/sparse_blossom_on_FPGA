...
// wrapc file define:
#define AUTOTB_TVIN_syndrome "../tv/cdatafile/c.compute_corr.autotvin_syndrome.dat"
#define AUTOTB_TVOUT_syndrome "../tv/cdatafile/c.compute_corr.autotvout_syndrome.dat"
#define AUTOTB_TVIN_corrections "../tv/cdatafile/c.compute_corr.autotvin_corrections.dat"
#define AUTOTB_TVOUT_corrections "../tv/cdatafile/c.compute_corr.autotvout_corrections.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_corrections "../tv/rtldatafile/rtl.compute_corr.autotvout_corrections.dat"
...
extern "C"
void compute_corr_hw_stub_wrapper(void*, void*);

extern "C"
void apatb_compute_corr_hw(void* __xlx_apatb_param_syndrome, void* __xlx_apatb_param_corrections)
{
#ifdef USE_BINARY_TV_FILE
  ...
  static hls::sim::Memory<hls::sim::Reader, hls::sim::Writer> port0 {
    ...
    .owriter = nullptr,
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_syndrome),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_syndrome),
#endif
#endif
  };
  port0.param = { __xlx_apatb_param_syndrome };
  port0.depth = { 10 };
  port0.offset = {  };
...
#ifdef POST_CHECK
#ifdef USE_BINARY_TV_FILE
    .reader = new hls::sim::Input(AUTOTB_TVOUT_PC_corrections),
#else
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_corrections),
#endif
#else
#ifdef USE_BINARY_TV_FILE
    .owriter = new hls::sim::Output(AUTOTB_TVOUT_corrections),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_corrections),
#endif
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_corrections),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_corrections),
#endif
#endif
  };
  port1.param = { __xlx_apatb_param_corrections };
  port1.depth = { 10 };
  port1.offset = {  };
  port1.hasWrite = { true };
  ...
  try {
    ...
    compute_corr_hw_stub_wrapper(__xlx_apatb_param_syndrome, __xlx_apatb_param_corrections);
